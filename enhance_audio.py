...
def main(args):
    ...
    filtered_audio = noise_handler.filter_audio_with_ffmpeg(audio_file_path, high_cutoff=80, low_cutoff=3500)
...
if __name__ == '__main__':
    ...
    cli_parser.add_argument('--data_path', type=str, default='./meeting_records/wav')
